...
local config = {
  ...
  mappings = {
    ...
    n = {
      -- AstroReload
      ["<leader>."] = { "<cmd>AstroReload<cr>", desc = "Reload configuration" },
      -- Buffers
      ["<leader>bb"] = { "<cmd>b#<cr>", desc = "Last buffer" },
      ["<leader>bc"] = { "<cmd>BufferLinePickClose<cr>", desc = "Pick to close" },
      ["<leader>bn"] = { "<cmd>bn<cr>", desc = "Next" },
      ["<leader>bp"] = { "<cmd>bn<cr>", desc = "Previous" },
      ["<leader>bd"] = { "<cmd>bd %<cr>", desc = "Delete" },
      ["<leader>bD"] = { "<cmd>%bd|e#|bd#<cr>", desc = "Delete all buffers except this one" },
      -- files
      ["<leader>R"] = { "<cmd>e!<cr>", desc = "Reload" },
      -- Moving
      ["<leader>k"] = { "<cmd>m .-2<CR>==<cr>k", desc = "Move 1 up" },
      ["<leader>j"] = { "<cmd>m .+1<CR>==<cr>k", desc = "Move 1 down" },
      -- Moving
